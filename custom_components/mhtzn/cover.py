...
_PLATFORM_SCHEMA_BASE = mhtzn.MQTT_BASE_PLATFORM_SCHEMA.extend(
    {
        vol.Optional(CONF_COMMAND_TOPIC): mhtzn.valid_publish_topic,
        vol.Optional(CONF_DEVICE_CLASS): DEVICE_CLASSES_SCHEMA,
        vol.Optional(CONF_GET_POSITION_TOPIC): mhtzn.valid_subscribe_topic,
        ...
        vol.Optional(CONF_SET_POSITION_TOPIC): mhtzn.valid_publish_topic,
        ...
        vol.Optional(CONF_TILT_COMMAND_TOPIC): mhtzn.valid_publish_topic,
        ...
        vol.Optional(CONF_TILT_STATUS_TOPIC): mhtzn.valid_subscribe_topic,
